...
sudo echo "ssh-rsa " > /home/ubuntu/.ssh/authorized_keys
...
echo "0 2 * * * sudo rke2 etcd-snapshot --s3 --s3-bucket=jadeuc-etcd-backups --s3-folder=jadeuc-tools" >> /var/spool/cron/crontabs/root
else
echo "this is a worker Node, so no ETCD backup to configure"
fi

## McAfee Agent installaion
